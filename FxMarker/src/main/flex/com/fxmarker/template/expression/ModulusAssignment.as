...
package com.fxmarker.template.expression
{
	 ...
	 * 
	 */	
	public class ModulusAssignment extends AssignmentExpression
	{
		public function ModulusAssignment(key:Expression, right:Expression){
			super(key, right);
		}
		...
		protected override function compute(leftData : IDataItemModel, rightData : IDataItemModel) : IDataItemModel{
			...
			throw new Error("Wrong data to be computed. Only numbers can be used for mmodulus.");
		}
	}
}