...
package com.fxmarker.template.expression
{
	...
	{
		public function MultiplicationAssignment(key:Expression, right:Expression){
			super(key, right);
		}
		...
		protected override function compute(leftData : IDataItemModel, rightData : IDataItemModel) : IDataItemModel{
			...
			throw new Error("Wrong data to be computed. Only numbers must be used for multiplication");
		}
	}
}